...
public class CT03ConsultaCEPcomLogradouroEmBranco {
...
public void cT03ConsultaCEPcomLogradouroEmBranco() {
    ...
    driver.manage().window().setSize(new Dimension(960, 1050));
    ...
    driver.findElement(By.name("Tipo")).click();
    {
      ...
      dropdown.findElement(By.xpath("//option[. = 'Avenida']")).click();
    }
    driver.findElement(By.name("Tipo")).click();
